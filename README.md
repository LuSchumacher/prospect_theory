...
| Script | Description |
|---|---|
| [`00_data_preparation.R`](src/00_data_preparation.R) | Prepares the experimental data, applies the exclusion criteria, and produces descriptive summaries and choice plots. |
...
| [`06_gamble_set_diagnostics.R`](src/06_gamble_set_diagnostics.R) | Checks the stimulus construction and summarizes the distributional properties of the gamble set. |
| [`07_tom2007_reanalysis.R`](src/07_tom2007_reanalysis.R) | Reanalyzes the mixed-gamble data from Tom et al. (2007) using four alternative models. |
